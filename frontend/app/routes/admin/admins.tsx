...
const columns = [
        ...
        cell: (props: any) => {
            ...
            return (
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm font-medium text-gray-900">{props.getValue()}</p>
                </div>
            );
        }
    },
    {
        accessorKey: 'email',
        header: 'Email',
        cell: (props: any) => <p className="text-sm text-gray-600">{props.getValue()}</p>
    },
    {
            ...
            return (
                <div className="flex gap-2">
                    {actions.map((action: string, index: any) => (
                        action == 'delete' ?
                            <button className="p-2 text-red-600 transition-all rounded-lg cursor-pointer hover:bg-red-100 hover:scale-105" title="Delete">
                                <FaRegTrashAlt size={18} />
                            </button> :
                            <button className="p-2 text-blue-600 transition-all rounded-lg cursor-pointer hover:bg-blue-100 hover:scale-105" title="Edit">
